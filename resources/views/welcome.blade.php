...
<body>
    <header class="header">
        <div class="container">
            ...
            <nav class="nav">
                <a href="{{ route('login') }}" class="nav-link">Book Type</a>
                <a href="{{ route('login') }}" class="nav-link">ReserveBook</a>
                <a href="{{ route('login') }}" class="nav-link">seeBooks</a>
        ...
        <div class="container hero-container">
            <div class="hero-content">
                ...
                <div class="search-box">
                    ...
                    <button class="search-btn"><a href="{{ route('login') }}">Search</a></button>
                </div>
            </div>
